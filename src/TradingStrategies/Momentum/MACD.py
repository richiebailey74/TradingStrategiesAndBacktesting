from src.Utils import TradingStrategy, MovingAverage, RelativeStrengthIndex, CurrentPosition, StockOrder
...
class MACD(TradingStrategy):
    def __init__(
            ...
            trend_ma_day_count=200,  # default is 200 units of time
            momentum_ma_type='exponential',
            trend_ma_type='exponential',
            rsi_window=14,
        ...
        self.trend_ma = MovingAverage(trend_ma_type, trend_ma_day_count)
    ...
    def execute(self, current_position, stock_data):
        ...
        trend_line = self.trend_ma.ma_val
        ...
        if self.macd_above_signal is None:
            ...
            # crossover: macd cross above to below, indicates downward trend so sell longs (if possible) and sell shorts
                ...
                shorts_to_sell = round((current_position.capital / 2) / stock_data.close_p)
            ...
            if macd_line > signal_line:
                ...
                longs_to_buy = round((current_position.capital / 2) / stock_data.close_p)
        ...
        for key, value in current_position.shorts_sold_tracker.items():
            ...
            total_pnl += value * (key - stock_data.close_p)
        ...
        for key, value in current_position.longs_owned_tracker.items():
            ...
            total_pnl += value * (stock_data.close_p - key)
    ...
    def update_moving_averages(self, stock_data):
        ...
        self.trend_ma.update(data_point, datetime)

        return

    def update_rsi(self, stock_data):
        data_point = (stock_data.high_p + stock_data.low_p) / 2
